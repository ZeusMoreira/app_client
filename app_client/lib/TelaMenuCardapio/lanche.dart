...
class LancheAba extends StatefulWidget {
  @override
  _LancheAbaState createState() => _LancheAbaState();
}

class _LancheAbaState extends State<LancheAba> {
              ...
              switch (snapshot.connectionState) {
                ...
                case ConnectionState.done:
                  ...
                  for(int i=0; i < snapshot.data.length-1; i++){
                    ...
                    if(snapshot.data[id]['tipo'] == 'lanche'){
