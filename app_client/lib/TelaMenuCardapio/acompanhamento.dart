...
class AcompanhamentoAba extends StatefulWidget {
  @override
  _AcompanhamentoAbaState createState() => _AcompanhamentoAbaState();
}

class _AcompanhamentoAbaState extends State<AcompanhamentoAba> {
              ...
              switch (snapshot.connectionState) {
                ...
                case ConnectionState.done:
                  ...
                  for(int i=0; i < snapshot.data.length-1; i++){
                    ...
                    if(snapshot.data[id]['tipo'] == 'acompanhamento'){
