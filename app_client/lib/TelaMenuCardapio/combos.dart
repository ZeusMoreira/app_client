...
class ComboAba extends StatefulWidget {
  @override
  _ComboAbaState createState() => _ComboAbaState();
}

class _ComboAbaState extends State<ComboAba> {
              ...
              switch (snapshot.connectionState) {
                ...
                case ConnectionState.done:
                  ...
                  for(int i=0; i < snapshot.data.length-1; i++){
                    ...
                    if(snapshot.data[id]['tipo'] == 'combo'){
